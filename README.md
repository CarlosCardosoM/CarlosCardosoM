...
Aqui estão alguns dos projetos que desenvolvi durante a graduação:

| Projeto | Tech Stack | Descrição |
| :--- | :--- | :--- |
| **API RESTful** | `Java` | Desenvolvimento de uma API robusta seguindo boas práticas de arquitetura. |
| **Sistema em POO** | `Java` | Aplicação dos pilares da Programação Orientada a Objetos (Herança, Polimorfismo, Encapsulamento). |
...
<div align="center">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=CarlosCardosoM&show_icons=true&theme=dracula&include_all_commits=true&count_private=true"/>
